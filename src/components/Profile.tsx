...
export function Profile() {
  ...
  const fetchTokenInfo = async () => {
    ...
    try {
      ...
      console.log('토큰 정보 조회 완료:', { decimals, symbol, balance: balance.toString() })
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">ETH 잔액</p>
              {ethBalanceLoading ? (
                <p className="text-xl font-bold text-blue-800 dark:text-blue-200">로딩 중...</p>
              ) : ethBalanceError ? (
                <p className="text-xl font-bold text-red-800 dark:text-red-200">조회 실패</p>
              ) : ethBalance ? (
                <p className="text-xl font-bold text-blue-800 dark:text-blue-200">
                  {parseFloat(ethBalance.formatted).toFixed(4)} ETH
                </p>
              ) : (
                <p className="text-xl font-bold text-blue-800 dark:text-blue-200">0.0000 ETH</p>
              )}
            </div>
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">보유 NFT</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              사용 가능: {formatTokenAmount(tokenBalance, tokenDecimals)} {tokenSymbol}
            </p>
          </div>
